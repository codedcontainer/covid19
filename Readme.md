...
## Getting Started ##
- Install Salenium Web Driver for your os
- Install all packages `npm install`
- Create a new Google Spreadsheet doc with two sheets (u.s., indiana)
- Follow the authentication service account steps: https://theoephraim.github.io/node-google-spreadsheet/#/getting-started/authentication
- Go to document share > share with service email address
